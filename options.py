...
def parse_common_args(parser):
    parser.add_argument('--model_type', type=str, default='Kim_CNN', help='used in model_entry.py')
...
def parse_train_args(parser):
    ...
    parser.add_argument('--bert_path',type=str, default='digitalepidemiologylab/covid-twitter-bert-v2')
    # KE-MLM:
    # python train.py --bert_path "kornosk/bert-political-election2020-twitter-mlm"
    #Skep:
    # python train.py --bert_path "skep_ernie_2.0_large_en"
    #普通bert
    # python train.py --bert_path "bert-base-uncased"
